...
class SearchMode:
    videos = 'EgIQAQ%253D%253D' #'EgIQAQ%3D%3D'
...
class VideoFeatures:
    CreativeCommons = 'EgIwAQ'
    HDR = 'EgPIAQE'
    HDR_under4 = 'EgUYAcgBAQ'
    CC_HDR = 'EgUwAcgBAQ'
    CC_HDR_4K = 'EgcwAXAByAEB'
    CC_HDR_under4 = 'EgcYATAByAEB' #'EgcYATAByAEB'
    CC_HDR_under4_video = 'EgkQARgBMAHIAQE'
